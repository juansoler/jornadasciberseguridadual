...
import WorflowImg01 from "@/public/images/telefonica.png";
import WorflowImg02 from "@/public/images/3inlab.png";
import WorflowImg03 from "@/public/images/miolnir.png";
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  Antonio Pérez Seronellas y Luis Pablo del Árbol
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                  Informática Forense en el ámbito de la Ciberseguridad. 
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                  Noname057, ¿Hacktivistas o ciber terroristas?
Rafael López. Perception Point.
                  </p>
                </div>
              </div>
            </a>
